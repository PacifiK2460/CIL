...
export default function BackgroundSvg({
    ...
    return (
        <svg width="1000px" height="1000px" viewBox="0 0 2560 1920" fill="none"
        ...
        >
            ...
            <defs>
                <radialGradient id="paint0_radial_37_453-1" cx="0" cy="0" r="1"
                    ...
                    <stop offset="0.0833333" stopColor="var(--accent7)"></stop>
                    <stop offset="0.364583" stopColor="var(--accent5)"></stop>
                    <stop offset="0.658041" stopColor="var(--color-background)"></stop>
                    <stop offset="0.798521" stopColor="var(--accent9)"></stop>
                ...
                <radialGradient id="paint1_radial_37_453-1" cx="0" cy="0" r="1"
                    ...
                    <stop stopColor="var(--color-background)"></stop>
                    <stop offset="0.0833333" stopColor="var(--accent2)"></stop>
                    <stop offset="0.333803" stopColor="var(--accent1)"></stop>
                    <stop offset="0.658041" stopColor="var(--color-background)"></stop>
                    <stop offset="0.798521" stopColor="var(--accent9)"></stop>
                    <stop offset="0.942708" stopColor="var(--color-background)"></stop>
                    <stop offset="1" stopColor="var(--color-background)"></stop>
                ...
                <radialGradient id="paint2_radial_37_453-1" cx="0" cy="0" r="1"
                    ...
                    <stop stopColor="var(--color-background)"></stop>
                    <stop offset="0.140625" stopColor="var(--accent3)"></stop>
                    <stop offset="0.333803" stopColor="var(--accent7)"></stop>
                    <stop offset="0.658041" stopColor="var(--color-background)"></stop>
                    <stop offset="0.798521" stopColor="var(--accent9)"></stop>
                    <stop offset="0.942708" stopColor="var(--color-background)"></stop>
                    <stop offset="1" stopColor="var(--color-background)"></stop>
...
export default function BackgroundSvg(
    { colorBackground, accent1, accent2, accent3, accent5, accent7, accent9 }: BackgroundSvgProps
) {
    return (
        <svg width="1000px" height="1000px" viewBox="0 0 2560 1920" fill="none"
            xmlns="http://www.w3.org/2000/svg" style={
            ...
            <defs>
                <radialGradient id="paint0_radial_37_453-1" cx="0" cy="0" r="1"
                    gradientUnits="userSpaceOnUse"
                    gradientTransform="translate(-804.109 -2036.8) rotate(64.9401) scale(6436.87 6304.81)">
                    <stop stopColor={colorBackground}></stop>
                    <stop offset="0.0833333" stopColor={accent7}></stop>
                    <stop offset="0.364583" stopColor={accent5}></stop>
                    <stop offset="0.658041" stopColor={colorBackground}></stop>
                    <stop offset="0.798521" stopColor={accent9}></stop>
                    <stop offset="0.942708" stopColor={colorBackground}></stop>
                    <stop offset="1" stopColor={colorBackground}></stop>
                </radialGradient>
                <radialGradient id="paint1_radial_37_453-1" cx="0" cy="0" r="1"
                    gradientUnits="userSpaceOnUse"
                    gradientTransform="translate(201.6 -1080.02) rotate(64.9401) scale(6436.87 6304.81)">
                    <stop stopColor={colorBackground}></stop>
                    <stop offset="0.0833333" stopColor={accent2}></stop>
                    <stop offset="0.333803" stopColor={accent1}></stop>
                    <stop offset="0.658041" stopColor={colorBackground}></stop>
                    <stop offset="0.798521" stopColor={accent9}></stop>
                    <stop offset="0.942708" stopColor={colorBackground}></stop>
                    <stop offset="1" stopColor={colorBackground}></stop>
                ...
                <radialGradient id="paint2_radial_37_453-1" cx="0" cy="0" r="1"
                    ...
                    gradientTransform="translate(912.834 -811.021) rotate(64.9401) scale(6436.87 6304.81)">
                    <stop stopColor={colorBackground}></stop>
                    <stop offset="0.140625" stopColor={accent3}></stop>
                    <stop offset="0.333803" stopColor={accent7}></stop>
                    <stop offset="0.658041" stopColor={colorBackground}></stop>
                    <stop offset="0.798521" stopColor={accent9}></stop>
                    <stop offset="0.942708" stopColor={colorBackground}></stop>
                    <stop offset="1" stopColor={colorBackground}></stop>
